...
// stays in the report marked suppressed with a reason. A lower band is the wrong lever for a false
// positive, and using it that way is the same category error this fixes.
