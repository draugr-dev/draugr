...
var openStrings = map[string]string{
	// Nested inside a scanner's or a control's declared options, published verbatim.
	"$defs.control_iac.properties.trivyConfig.properties.checks.items":                                                   "a Trivy check ID, from a set Trivy's own rule bundle defines",
	"$defs.control_iac.properties.trivyConfig.properties.namespaces.items":                                               "a Rego policy namespace the organization writes",
	"$defs.control_images.properties.trivy.properties.dbRepository.items":                                                "an OCI reference to a database mirror",
	"$defs.control_sca.properties.trivyFs.properties.dbRepository.items":                                                 "an OCI reference to a database mirror",
	"$defs.control_licenses.properties.deny.items":                                                                       "a license identifier, SPDX or as a scanner reports it",
	"$defs.control_licenses.properties.warn.items":                                                                       "a license identifier, SPDX or as a scanner reports it",
	"$defs.control_licenses.properties.mendLicenses.properties.deny.items":                                               "a license identifier, SPDX or as a scanner reports it",
	"$defs.control_licenses.properties.mendLicenses.properties.warn.items":                                               "a license identifier, SPDX or as a scanner reports it",
	"$defs.control_licenses.properties.trivyLicense.properties.deny.items":                                               "a license identifier, SPDX or as a scanner reports it",
	"$defs.control_licenses.properties.trivyLicense.properties.warn.items":                                               "a license identifier, SPDX or as a scanner reports it",
	"$defs.control_sast.properties.gosec.properties.tags.items":                                                          "a Go build tag the project defines",
	"$defs.control_provenance.properties.signers.items.properties.name":                                                  "the name somebody gave one of their signers",
	"$defs.fragmentControls.properties.provenance.properties.signers.items.properties.name":                              "the name somebody gave one of their signers",
	"$defs.control_provenance.properties.signers.items.properties.images.items":                                          "an image reference, with * matching a run of characters",
	"$defs.fragmentControls.properties.provenance.properties.signers.items.properties.images.items":                      "an image reference, with * matching a run of characters",
	"$defs.control_provenance.properties.signers.items.properties.keyless.properties.issuer":                             "an OIDC issuer URL",
	"$defs.fragmentControls.properties.provenance.properties.signers.items.properties.keyless.properties.issuer":         "an OIDC issuer URL",
	"$defs.control_provenance.properties.signers.items.properties.keyless.properties.identity":                           "a signing identity, the workflow URL a certificate names",
	"$defs.fragmentControls.properties.provenance.properties.signers.items.properties.keyless.properties.identity":       "a signing identity, the workflow URL a certificate names",
	"$defs.control_provenance.properties.signers.items.properties.keyless.properties.identityRegexp":                     "a Go regular expression over signing identities",
	"$defs.fragmentControls.properties.provenance.properties.signers.items.properties.keyless.properties.identityRegexp": "a Go regular expression over signing identities",
	"$defs.control_provenance.properties.signers.items.properties.x509.properties.subject":                               "a certificate subject distinguished name",
	"$defs.fragmentControls.properties.provenance.properties.signers.items.properties.x509.properties.subject":           "a certificate subject distinguished name",
	"$defs.control_provenance.properties.signers.items.properties.x509.properties.trustStore":                            "a path to a PEM file",
	"$defs.fragmentControls.properties.provenance.properties.signers.items.properties.x509.properties.trustStore":        "a path to a PEM file",
	"$defs.control_provenance.properties.signers.items.properties.github.properties.repository":                          "a GitHub repository, owner/name",
	"$defs.fragmentControls.properties.provenance.properties.signers.items.properties.github.properties.repository":      "a GitHub repository, owner/name",
	"$defs.control_provenance.properties.signers.items.properties.github.properties.workflow":                            "a workflow file path",
	"$defs.fragmentControls.properties.provenance.properties.signers.items.properties.github.properties.workflow":        "a workflow file path",
	"$defs.control_provenance.properties.signers.items.properties.github.properties.ref":                                 "a git ref",
	"$defs.fragmentControls.properties.provenance.properties.signers.items.properties.github.properties.ref":             "a git ref",
